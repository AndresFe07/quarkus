...
You can then execute your native executable with: `./target/amq-test-1.0.0-runner`
...
----
docker run -d -e AMQ_USER=4WBAKkUu -e AMQ_PASSWORD=pHAWbFhF -p 61616:61616 -p 8161:8161 quay.io/artemiscloud/activemq-artemis-broker
----