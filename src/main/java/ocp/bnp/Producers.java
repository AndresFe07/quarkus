...
public class Producers {
     ...
     *
     * @param wrapper
     *            wrapper that is used to add pooling capabilities to the connection factory
     *
     ...
     *
     * @param cf
     *            ibm mq connection factory that is automatically injected by Quarkus based on the given identifier
     * @param tm
     ...
     *
     * @param cf
     *            activemq connection factory that is automatically injected by Quarkus based on the given identifier
     * @param tm
     *            transaction manager to use
     *
     * @return a new JmsComponent instance
